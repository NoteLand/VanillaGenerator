...
class OrePopulator extends OverworldOrePopulator{
	...
	public function __construct(int $world_height = World::Y_MAX){
		$this->addOre(new OreType(VanillaBlocks::NETHER_GOLD_ORE(), 10, 117, 16, BlockTypeIds::NETHERRACK), 10);
		...
		$this->addOre(new OreType(VanillaBlocks::ANCIENT_DEBRIS(), 8, 22, 2, BlockTypeIds::NETHERRACK), 1);
	}
}